...
- Create Angular project with ng: `ng new dynamicformapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`dynamicformapp.client.esproj`).
